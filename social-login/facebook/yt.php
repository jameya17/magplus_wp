...
curl_setopt_array($curl, array(
 CURLOPT_URL => "https://publish.magplus.com/registration?redirect_to=https://www.magplus.com/thank-you-for-registering-with-magplus/&verify_redirect_to=https://www.magplus.com/thank-you-for-registering-with-magplus/&failed_redirect_to=https://www.magplus.com/signup/&00N7F00000HNBcC=121.244.129.246&registration[first_name]=" . $pieces[0] . "&registration[name]=" . $pieces[1] . "&registration[email]=" . $_SESSION['userData']['email'] . "&registration[password]=" . $_SESSION['userData']['email'] . "&registration[country_code]=%20&registration[phone]=NA&registration[company]=NA&registration[accept_terms]=1&registration[gdpr]=1&registration[state]=NA&registration[from_where]=https://www.magplus.com/signup/&registration[city]=New%20Delhi&registration[zip]=100100&registration[social_media_provider]=facebook",
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => "",
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,

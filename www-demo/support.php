                ...
                <div class="g-col align-center">
                    <div class="content-block">
                        ...
                        <div class="small-wrap">
                            ...
                            <a href="/mega-plus/www/tutorials.php" class="primary-btn align-center" title="Watch All Tutorials">
                        ...
                        <div class="owl-carousel full-wrap-carousel">
                            <div class="item">
                                <a href="/" target="_blank" rel="" class="item-image">
                                    <img src="images/temp-schedule-demo.svg" alt="" />        
            ...
            <div class="l-section-wrap"> 
                <div class="g-col align-center">
                    <div class="content-block">
                        ...
                        <div class="small-wrap">
                            <p>Mag+ makes it easy to publish your content to your own mobile app. From text to video to interactive elements, no matter the source, the mag+ software lets you bring your content to life on tablets and phones with no coding and no hassles.</p>
                            <a href="/mega-plus/www/case-studies.php" class="primary-btn align-center" title="View All Case Studies">
                            ...
                            <div class="owl-carousel section-carousel">
                                <div class="g-col offset_default item">
                                    <div class="one-half image-block">
                                        <img src="images/case-study-temp1.png" alt="App Update Services">  
                                    </div>

                                    <div class="one-half item-detail">
                                        <h3 class="sec-title">Enhance Your Brand Potential With Giant Advertising Blimps</h3>
                                        <p>mag+ does it all! Your existing mag+ apps are upgraded to the latest mag+ version and published to the marketplaces of your choice. Choose to customize your app with new features, modified app content, or updated OS versions to enhance user experience.</p>
                                        <a href="#" class="text-link">View Case study +</a>
                                    </div>        
                                </div>
                                <div class="g-col offset_default item">
                                    <div class="one-half image-block">
                                        <img src="images/case-study-temp2.png" alt="App Update Services">  
                                    </div>
            ...
            <div class="l-section-wrap">
                <div class="g-col align-center">
                    <div class="content-block">
                        ...
                        <div class="small-wrap">
                            <p>Mag+ makes it easy to publish your content to your own mobile app. From text to video to interactive elements, no matter the source, the mag+ software lets you bring your content to life on tablets and phones with no coding and no hassles.</p>
                            <a href="/mega-plus/www/blog-listing.php" class="primary-btn align-center" title="View All Blogs"> 
                        ...
                        <div class="nonloop owl-carousel col-carousel two-col-carousel"> 
                            <div class="card card-with-image item">
                                <div class="card-body">
                                    <div class="card-image">
                                        <img src="images/blog-temp1.svg" alt="" />  
                                    </div>
                            ...
                            <div class="card card-with-image item">
                                <div class="card-body">
                                    <div class="card-image">
                                        <img src="images/blog-temp2.svg" alt="" />  
                                    </div>
                                    <div class="card-body-con">
                                        <span class="publish-date">August 6, 2017 </span>
                                        <h5 class="card-title two-ellipsis">Computer Hardware Desktops And Notebooks And Handhelds Oh My</h5>

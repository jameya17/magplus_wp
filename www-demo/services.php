    ...
    <div class="container">
                ...
                <div class="l-sub-section-pad">
                    <div class="g-col">
                        ...
                        <div class="one-half image-block">
                            <img src="images/creative-services.svg" alt="Creative Services" />
                        </div>    
                    </div>    
                </div>    
            </div>
        ...
        <section class="l-section sec-pad grey-bg">
            <div class="l-section-wrap">
                <div class="g-col">
                    <div class="one-half image-block">
                        <img src="images/app-submission-services.svg" alt="App Submission Services" />
                    </div>    
                    <div class="one-half">
            ...
            <div class="l-section-wrap">
                <div class="l-sub-section-pad">
                    <div class="g-col">
                        ...
                        <div class="one-half image-block">
                            <img src="images/app-update-services.svg" alt="App Update Services" />  
                        </div>    
                    </div>    
                </div>    
            </div>

...
if(in_array($_SERVER['SERVER_NAME'], $devEnvironments)){
	...
	define('MAGPLUS_REGISTER_REDIRECT', "http://d3v.magplus.com/my-magplus/?message=new-user");
	define('MAGPLUS_VERIFY_REDIRECT', "http://d3v.magplus.com/my-magplus/?message=new-user");
//	define('MAGPLUS_FAILED_REDIRECT', "http://betamagplus.mpstechnologies.com/signup/");
	define('MAGPLUS_FAILED_REDIRECT', "http://d3v.magplus.com/signup/");
	define('MAGPLUS_DOWNLOAD_URL', "http://download.magplus.com/");
}else{
	...
	//define('MAGPLUS_FAILED_REDIRECT', "http://www.magplus.com/signup/");
...
<div id="inner-message" class="alert alert-error"><button class="close" type="button" data-dismiss="alert">�</button></div>
		...
		<input type="hidden" class="register-new-form-where" name="where" value="www">
		...
		<div class="signup-row">
			...
			<input class="text" name="registration[first_name]" type="text" autofocus="autofocus" required="required">
			<span class="ps-error"></span>
		</div>
		<div class="signup-row">
			<label for="registration-name">Last name<span style="color:red" >*</span></label>
			<input class="text" name="registration[name]" required="required" type="text" >
			<span class="ps-error"></span>
		</div>
		<div class="signup-row">
		...
		<div class="signup-row signup-country-row">
			...
			.'
			<input class="registration-phone" name="registration[phone]" type="tel" >
			<span class="ps-error"></span>
		</div>	
		<div class="signup-row">
		...
		<div class="signup-row">
			...
			<select id="sf_countries" name="country" required="required" class="form-control error" placeholder="" aria-required="true">
...
Media">Marketing / Media</option><option value="Medical">Medical</option><option value="Museum">Museum</option><option value="Publishing">Publishing</option><option value="Retail">Retail</option><option value="Travel">Travel</option><option value="Sports">Sports</option><option value="Other..">Other..</option></select>
		...
		<div class="submit-area">
			...
			<input name="commit" class="primary-button" type="submit" value="Sign up">
		</div>
		<input type="hidden" id="sf_Lead_Event_Origin__c" class="w2linput hidden" name="registration[Lead_Event_Origin__c]" value="Website Form: Sign-up">
...
function mag_download_form( $class = '' ){
	...
	if(!magplus_logged_in_check()) {
		return 'Please <a href="https://login.magplus.com?https://www.magplus.com/my-magplus">login</a> to download our tools.';
	}
	$out = '

	<form action="'. MAGPLUS_DOWNLOAD_URL .'" class="magplus-download '. $class .'" method="get">
		<div class="ps-split">
			<select name="cs_version" id="cs_version" class="cs_version">
				...
				<option value="CS6" id="cs_version_CS6">CS 6</option>
				<option value="CS5.5" id="cs_version_CS5_5">CS 5.5</option>
				<option value="CS5" id="cs_version_CS5">CS 5</option>
				<option value="CS4" id="cs_version_CS4">CS 4</option>
			</select>
		</div>
		<div class="ps-split">

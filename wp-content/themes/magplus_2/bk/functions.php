...
function vc_remove_wp_ver_css_js11( $src ) {
    if ( strpos( $src, 'version=' ) )
        $src = remove_query_arg( 'version', $src );
	    
    return $src;
}
add_filter( 'style_loader_src', 'vc_remove_wp_ver_css_js11', 9999 );
add_filter( 'script_loader_src', 'vc_remove_wp_ver_css_js11', 9999 );
...
function add_btn_mymag() {
	...
	$btn_mymag =
		'<li ' . $class . '>' .
			'<a href="' . get_permalink( MY_MAGLUS_ID ) . '" title="Home" id="d_olg" target="_blank">Download</a>'.
		'</li>';
...
if ( ! function_exists('magplus_theme_setup') ):
	function magplus_theme_setup() {
		...
		register_nav_menus( array(
			...
			'footer-menu-legal' => 'Footer menu : legal',
...
function magplus_styles() {
	...
	wp_enqueue_style('style', get_stylesheet_uri().cachBust(get_stylesheet_directory()), true, '11.7');
	//wp_enqueue_style('stylee',  get_stylesheet_directory_uri() . '/custom.css');
	//wp_enqueue_style('style', get_stylesheet_uri().cachBust(get_stylesheet_directory()), true, '10.1');
...
function itf_create_new_url_querystring() {
    add_rewrite_rule(
        'blog/([^/]*)$',
...
add_action('init', 'itf_create_new_url_querystring', 999 );

function itf_append_query_string( $url, $post, $leavename ) {
	if ( $post->post_type == 'post' ) {		
		$url = home_url( user_trailingslashit( "blog/$post->post_name" ) );
	}
	return $url;
}
add_filter( 'post_link', 'itf_append_query_string', 10, 3 );

add_action( 'send_headers', 'send_frame_options_header', 10, 0 );


//addinng short code for chargbee
function vComp( $atts ){
	...
	if(isset($data->email)){
		...
		$time = '<!--Pricing table start for desktop view + tab view --> <div class="hide-small"> <div class="mt-30"> <div class="mar-t-b25"> <div class="col-sm-3 no-pad-tab "> <div class="price_table_container"> <div class="price_table_body"> <div class="price_table_row cost table-bg"> <span class="font18"><strong>$</strong></span><span class="font34">3499</span> <div class="table-cost-bg ">one-time fee</div> <div class="package-head">Single</div> <div class="price-font14">One App<br> Publish Once</div> <div class="mt-30"> <a href="https://magplus-test.chargebee.com/hosted_pages/plans/SP-single_pro?customer[email]='.$data->email.'&billing_address[first_name]='.$namearray[0].'&billing_address[last_name]='.$lastname.'" class="btn btn-primary ">Buy Now</a> </div> </div> </div> </div> </div> <!-- Plan2 start--> <div class="col-sm-3 no-pad-tab "> <div class="price_table_container"> <div class="price_table_body"> <div class="price_table_row cost table-bg"> <span class="font18"><strong>$</strong></span><span class="font34">8388</span> <div class="table-cost-bg ">Per Content Update</div> <div class="package-head">Pay as You Publish</div> <div class="price-font14">One App <br> Pay only when you Publish</div> <div class="mt-30"> <a href="https://magplus-test.chargebee.com/hosted_pages/plans/Notlinked-Mag%2B-MultiProAnnual?customer[email]='.$data->email.'&billing_address[first_name]='.$namearray[0].'&billing_address[last_name]='.$lastname.'" class="btn btn-primary ">Buy Now</a> </div> </div> </div> </div> </div> <!-- Plan2 end--> <!-- Plan3 start--> <div class="col-sm-3 no-pad-tab"> <div class="price_table_container"> <div class="price_table_body"> <div class="price_table_row cost table-bg"> <span class="font18"><strong>$</strong></span><span class="font34">5988<span class="font18"><strong>/mo</strong></span></span> <div class="table-cost-bg-blue">1 year commitment</div> <div class="package-head">Multi</div> <div class="price-font14">One App <br> Unlimited Publishing</div> <div class="mt-30"> <a href="https://magplus-test.chargebee.com/hosted_pages/plans/Notlinked-Mag%2B-MultiAnnual?customer[email]='.$data->email.'&billing_address[first_name]='.$namearray[0].'&billing_address[last_name]='.$lastname.'" class="btn btn-primary ">Buy Now</a> </div> </div> </div> </div> </div> <!-- Plan3 end--> <!-- Plan4 start--> <div class="col-sm-3 no-pad-tab "> <div class="price_table_container pricing-shadow mt"> <div class="price_table_body"> <div class="price_table_row cost table-bg"> <div style="padding:7px;"><strong>MOST POPULAR</strong></div> <span class="font18" style="color: #06d2ec;"><strong>$</strong></span><span class="font34" style="color: #06d2ec;">2999<span class="font18"><strong>/mo</strong></span></span> <div class="table-cost-bg-blue">1 year commitment</div> <div class="package-head">Multi Pro</div> <div class="price-font14">One App <br> Unlimited Publishing & Web Export</div> <div class="mt-30"> <a href="https://magplus-test.chargebee.com/hosted_pages/plans/Notlinked-Mag%2B-All-Access?customer[email]='.$data->email.'&billing_address[first_name]='.$namearray[0].'&billing_address[last_name]='.$lastname.'" class="btn btn-primary ">Buy Now</a> </div> </div> </div> </div> </div> <!-- Plan4 end--> ';
	}else{
		$time = '<!--Pricing table start for desktop view + tab view --> <div class="hide-small"> <div class="mt-30"> <div class="mar-t-b25"> <div class="col-sm-3 no-pad-tab "> <div class="price_table_container"> <div class="price_table_body"> <div class="price_table_row cost table-bg"> <span class="font18"><strong>$</strong></span><span class="font34">3499</span> <div class="table-cost-bg ">one-time fee</div> <div class="package-head">Single</div> <div class="price-font14">One App<br> Publish Once</div> <div class="mt-30"> <a href="https://magplus-test.chargebee.com/hosted_pages/plans/SP-single_pro" class="btn btn-primary ">Buy Now</a> </div> </div> </div> </div> </div> <!-- Plan2 start--> <div class="col-sm-3 no-pad-tab "> <div class="price_table_container"> <div class="price_table_body"> <div class="price_table_row cost table-bg"> <span class="font18"><strong>$</strong></span><span class="font34">8388</span> <div class="table-cost-bg ">Per Content Update</div> <div class="package-head">Pay as You Publish</div> <div class="price-font14">One App <br> Pay only when you Publish</div> <div class="mt-30"> <a href="https://magplus-test.chargebee.com/hosted_pages/plans/Notlinked-Mag%2B-MultiProAnnual" class="btn btn-primary ">Buy Now</a> </div> </div> </div> </div> </div> <!-- Plan2 end--> <!-- Plan3 start--> <div class="col-sm-3 no-pad-tab"> <div class="price_table_container"> <div class="price_table_body"> <div class="price_table_row cost table-bg"> <span class="font18"><strong>$</strong></span><span class="font34">5988<span class="font18"><strong>/mo</strong></span></span> <div class="table-cost-bg-blue">1 year commitment</div> <div class="package-head">Multi</div> <div class="price-font14">One App <br> Unlimited Publishing</div> <div class="mt-30"> <a href="https://magplus-test.chargebee.com/hosted_pages/plans/Notlinked-Mag%2B-MultiAnnual" class="btn btn-primary ">Buy Now</a> </div> </div> </div> </div> </div> <!-- Plan3 end--> <!-- Plan4 start--> <div class="col-sm-3 no-pad-tab "> <div class="price_table_container pricing-shadow mt"> <div class="price_table_body"> <div class="price_table_row cost table-bg"> <div style="padding:7px;"><strong>MOST POPULAR</strong></div> <span class="font18" style="color: #06d2ec;"><strong>$</strong></span><span class="font34" style="color: #06d2ec;">2999<span class="font18"><strong>/mo</strong></span></span> <div class="table-cost-bg-blue">1 year commitment</div> <div class="package-head">Multi Pro</div> <div class="price-font14">One App <br> Unlimited Publishing & Web Export</div> <div class="mt-30"> <a href="https://magplus-test.chargebee.com/hosted_pages/plans/Notlinked-Mag%2B-All-Access" class="btn btn-primary ">Buy Now</a> </div> </div> </div> </div> </div> <!-- Plan4 end--> ';
	}

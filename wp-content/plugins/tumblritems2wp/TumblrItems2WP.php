...
/*
Plugin Name: TumblrItems2WP
Plugin URI: http://Improove.se/TumblrItems2WP
Description: Scheduled automatic posting of shared links on Tumblr.
Version: 1.0
Author: <a href="http://www.googletutor.com/" title="Original author">Craig Fifield (Google Tutor)</a>, <a href="http://satf.se" title="Fork developer">Jonas Skovmand</a>, <a href="http://jardenberg.se" title="Forker and initiative taker">Joakim Jardenberg</a> and <a href="http://fridholm.net" title="Contributor">Marcus Fridholm</a>, <a href="http://satf.se" title="Yet another fork developer">Per-Mattias Nordkvist</a>,
*/
...
if (!class_exists('TumblrItems2WP')) {
    class TumblrItems2WP
    {
	...
	var $max_origin_url_iteration = 4;
        ...
        var $default_options = array(
            ...
            'post_header_template' => '&lt;ol&gt;',
            'post_footer_template' => '&lt;/ol&gt;',
            'post_item_template' => '&lt;li&gt;%NOTE%&lt;/li&gt;',
            'post_note_template' => '',
            'post_category' => 1,
            'post_tags' => '',
            'post_author' => 1,
		...
		/**
		 * Checks if TumblrItems2WP is scheduled to post
		 * @return boolean
		 */
	...
	function save ( )
	{
		...
		$this->o["feed_url"] = $share_url;
		update_option($this->options_key, $this->o);
		$this->status = "ok";
	}
	
        function generate_post() {
			if ($this->o["share_url"] == "") return;
            $rss = new SimplePie();
            $rss->set_feed_url($this->o["share_url"]);
            ...
            foreach ($rss->get_items() as $item) {
                ...
                if ($this->o["last_crawl"] < $entry_time) {
        ...
        function admin_menu() {
            add_submenu_page('options-general.php','TumblrItems2WP', 'TumblrItems2WP', 9, basename(__FILE__), array($this, 'options_panel'));
        }
...
<div class="wrap"><h2>TumblrItems2WP</h2>
